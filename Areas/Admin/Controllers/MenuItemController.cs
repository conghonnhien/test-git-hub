...
namespace DienTu.Areas.Admin.Controllers
{
    ...
    public class MenuItemController : Controller
    {
        ...
        public async Task<IActionResult> CreatePOST()
        {
            ...
            {
                var uploads = Path.Combine(webRootPath, @"images\" + SD.DeafaultFoodImage);
        ...
        public async Task<IActionResult> EditPOST(int? id)
        {
            ...
            menuItemFromDb.Guarantee = MenuItemVM.MenuItem.Guarantee;
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            MenuItemVM.MenuItem = await _db.MenuItem.Include(a => a.Category).Include(a => a.SubCategory).SingleOrDefaultAsync(a => a.Id == id);
